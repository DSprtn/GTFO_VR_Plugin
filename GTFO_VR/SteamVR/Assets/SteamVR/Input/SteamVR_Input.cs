...
namespace Valve.VR
{
    public partial class SteamVR_Input
    {
        ...
        public static bool CreateEmptyActionsFile(bool completelyEmpty = false)
        {
            ...
            {
                Debug.LogErrorFormat("<b>[SteamVR_Standalone]</b> Actions file already exists in project root: {0}", actionsFilePath);
                return false;
            }
        ...
        public static bool InitializeFile(bool force = false, bool showErrors = true)
        {
            ...
            {
                if (showErrors)
                    Debug.LogErrorFormat("<b>[SteamVR_Standalone]</b> Actions file does not exist in project root: {0}", actionsFilePath);
