# SteamVR_Standalone Unity Plugin - v2.5 (sdk 1.8.19)
...
Requirements:
 ...
 The SteamVR_Standalone runtime must be installed. This can be found in Steam under Tools.

 We strongly recommend you opt-in to the SteamVR_Standalone Beta to make sure your application will work with future versions of SteamVR_Standalone. Right-click SteamVR_Standalone inside steam, click Properties, the beta tab, then select the beta branch.
...
Quick Start:
 ...
 If you want to explore the interaction scene you'll need to open the SteamVR_Standalone Input window (under the Window Menu), click yes to copy example jsons, then click Save and Generate to create input actions.
 ...
 * Fixes the Open Binding UI button. This should now work on all computers as it opens the window in SteamVR_Standalone instead of through your default browser.
 ...
 * Fixed the SteamVR_Standalone binding hint ui. This lets you show the user (through a SteamVR_Standalone interface) what actions are mapped to what bindings in a specified set. See: SteamVR_Input.ShowBindingHints(Action), SteamVR_Input.ShowBindingHints(ActionSet), SteamVR_Input.ShowBindingHints(ActionSet), SteamVR_Input.ShowBindingHintsForActiveActionSets()

 * SteamVR_Behaviour_Skeleton will now initialize SteamVR_Standalone if a Pose has not already done so.
 ...
 * Pathing fixes to allow nesting of the SteamVR_Standalone folders
 ...
 * Added SteamVR_Standalone.GetHeadsetActivityLevel() which will give you the current state of the hmd (idle, in use, etc)
 ...
 * Added SteamVR_Standalone.asmdef.20192 for Unity 2019.2b and 2019.3a - replace SteamVR_Standalone.asmdef to fix UI errors in these versions.


Changes for 2.3.1b

 * Added legacy mixed reality camera mode (enabled by default). You can change this in SteamVR_Standalone/Resources/SteamVR_Settings.
 ...
 * Fix for setting Universe Origin at runtime. SteamVR_Standalone.settings.trackingOrigin will automatically set all pose origins and the compositor origin (hmd)
 ...
 * Fixing issue where sometimes SteamVR_Standalone would load legacy bindings for SteamVR_Standalone Input projects while in the editor.


Changes for v2.2RC4:

 * Changed SteamVR_Input.isStartupFrame to return true for the couple frames around startup. This fixes some startup errors temporarily until we have a SteamVR_Standalone API to determine startup state.
 ...
 * Feature: Added SteamVR_Skeleton_Poser component that simplifies creating poses that are easily compatible with the SteamVR_Standalone Skeletal System. Check the objects in the Interaction System scene for examples or add the component to an interactable. More documentation on this feature will come before release. Example poses will be improved before release.
 ...
 * Fixed an issue where automatic SteamVR_Standalone Input calls on frame 0 would cause errors.
 ...
 * Major Breaking Change: To allow for the new SteamVR_Standalone plugin to use assembly definition files generated action properties have been moved to the SteamVR_Actions class. Since this was already breaking references to actions we've also created friendlier names. SteamVR_Input.__actions_default_in_GripGrab -> SteamVR_Actions.default_GripGrab
 ...
 * Fix for Mixed Reality camera configs. The Example actions now have a "mixedreality" action set with an "ExternalCamera" pose action. Set this pose to a tracker / controller and mixed reality should work again. By default the camera tracker type is bound to this action. You can also change the pose that's used in SteamVR_Standalone/Resources/ExternalCamera.
 ...
 * Bolded [SteamVR_Standalone] in Debug.log entries

 * Fixed a rigidbody issue with 2018.3

 * Fixed some issues with delayed loading SteamVR_Standalone. Added a test scene: SteamVR_Standalone/Extras/SteamVR_ForceSteamVRMode.unity

 * Readded the laser pointer extra with an example scene: SteamVR_Standalone/Extras/SteamVR_LaserPointer.unity

 * Fixed auto-enabling of vr mode in recent unity versions. (Reminder you can disable this in: Edit Menu -> Preferences -> SteamVR_Standalone)
 ...
 * Updated to SteamVR_Standalone runtime v1537309452 and SDK version 1.0.16.
 ...
 * Fixed an issue in the SteamVR_Standalone Input Live View that made it unreadable
 ...
 * Added built in support for delayed loading of SteamVR_Standalone. You can now call SteamVR_Standalone.Initialize() and pass a boolean to force set unity to OpenVR mode.

 * Added a new Simple Sample scene in the root to do super basic testing.

 * Moved SteamVR_Standalone Input updating to SteamVR_Behaviour which also handles the SteamVR_Render component. This will be added to scenes at runtime.
 ...
 * Namespacing all SteamVR_Standalone scripts. This will be a breaking change for most projects but this is a major revision.
...
* SteamVR_Input_References has been moved to the generated folder so new plugin updates don't wipe yours. Prior beta users: Please delete your existing one in Assets/SteamVR_Standalone/Resources/SteamVR_Input_References.asset
...
* Integrated SteamVR_Standalone Input System.
...
* [InteractionSystem] Integrated SteamVR_Standalone Input System. Actions and Action Sets instead of buttons.
...
* Updated to SteamVR_Standalone runtime v1515522829 and SDK version 1.0.12.
...
* Updated to SteamVR_Standalone runtime v1497390325 and SDK version 1.0.8.
...
* Updated to SteamVR_Standalone runtime v1485823399 and SDK version 1.0.6.
...
* Added Unity Preferences for SteamVR_Standalone to allow disabling automatic enabling of native OpenVR support in Unity 5.4 or newer.
...
* Fixes for SteamVR_Standalone on Linux.


Changes for v1.2.0:

* Updated to SteamVR_Standalone runtime v1481926580 and SDK version 1.0.5.
...
* Updated to SteamVR_Standalone runtime v1467410709 and SDK version 1.0.2.
...
* Updated to SteamVR_Standalone runtime v1461626459 and SDK version 0.9.20.

* Updated workshop texture used in sea of cubes example level to use web page from SteamVR_Standalone (was previously from Portal).
...
* Forced SteamVR_Standalone initialization check in SteamVR_Camera.enable (and bail upon failure) in Unity 5.4 (was already doing this in older builds).
...
* Updated to SteamVR_Standalone runtime v1457155403.
...
* SteamVR_Standalone auto-disabled if initialization fails, to avoid continual retries.
...
* Updated to SteamVR_Standalone runtime v1448479831.
...
* Updated to SteamVR_Standalone runtime v1446847085.
...
* Added SteamVR_Standalone.enabled which can be set to false to keep SteamVR_Standalone.instance from initializing SteamVR_Standalone.


Changes for v1.0.5:

* Updated to SteamVR_Standalone runtime build #826021 (v.1445485596).
...
* Couple fixes to prevent SteamVR_Standalone from getting re-initialized when stopping the Editor preview.

* Fix for hitches caused by SteamVR_PlayArea when not running SteamVR_Standalone.


Changes for v1.0.4:

* Updated to SteamVR_Standalone runtime build #768489 (v.1441831863).
...
* Added lockPhysicsUpdateRateToRenderFrequency to SteamVR_Render ([SteamVR_Standalone] prefab) for apps that want to run their physics sim at a lower frequency.  Locked (true) by default.
...
* Updated to SteamVR_Standalone runtime build #710329 (v.1438035413).

* Added SteamVR_Controller.DeviceRelation.FarthestLeft/Right for GetDeviceIndex helper function.
Note: You can also use SteamVR_Standalone.instance.hmd.GetSortedTrackedDeviceIndicesOfClass.
...
* Added collection of handy scripts to Assets/SteamVR_Standalone/Extras: GazeTracker, IK (simple two-bone),
...
* Updated to SteamVR_Standalone runtime build #655277.
...
* Fix for [SteamVR_Standalone] instance sometimes showing up twice in a scene between level loads and stomping existing
settings.

* Switched Overlay over to using new interface.  Please report any functional differences to the SteamVR_Standalone forums.
...
* Updated to SteamVR_Standalone runtime build #629708.
...
to compensate with an AA post fx.  The MSAA settings for SteamVR_Standalone's render buffers are controlled via Unity's
Quality settings (Edit > Project Settings > Quality > Anti Aliasing).


Upgrading from previous versions:

The easiest and safest thing to do is to delete your SteamVR_Standalone folder, and any files and folders in your
Plugins directory called 'openvr_api', 'steam_api' or 'steam_unity' (and variants).  Additionally, verify there
are no SteamVR_Standalone files found in Assets/Editor.  Then import the new unitypackage into your project.
...
'head'.  By pressing the 'Expand' button below the SteamVR_Standalone logo in SteamVR_Camera's Inspector, these objects are
...
SteamVR_Camera is itself used to render each eye.  And finally, the button below the SteamVR_Standalone logo will change to
...
Assets/Plugins/openvr_api.cs - This direct wrapper for the native SteamVR_Standalone SDK support mirrors SteamVR_Standalone.h and
is the only script required.  It exposes all functionality provided by SteamVR_Standalone.  It is not recommended you make
changes to this file.  It should be kept in sync with the associated openvr_api dll.

The remaining files found in Assets/SteamVR_Standalone/Scripts are provided as a reference implementation, and to get you
...
Assets/SteamVR_Standalone/Scenes/example.unity - A sample scene demonstrating the functionality provided by this plugin.
...
Assets/SteamVR_Standalone/Scripts/SteamVR_Standalone.cs - Handles initialization and shutdown of subsystems.  Use SteamVR_Standalone.instance
to access.  This may return null if initialization fails for any reason.  Use SteamVR_Standalone.active to determine if
VR has been initialized without attempting to initialized it in the process.

Assets/SteamVR_Standalone/Scripts/SteamVR_Camera.cs - Adds VR support to your existing camera object.
...
eye camera.  SteamVR_Standalone provides a recommended render target size as a minimum to account for distortion,
...
Assets/SteamVR_Standalone/Scripts/SteamVR_Overlay.cs - This component is provided to assist in rendering 2D content in VR.
...
Assets/SteamVR_Standalone/Scripts/SteamVR_TrackedObject.cs - Add this to any object that you want to use tracking.  The
...
Assets/SteamVR_Standalone/Scripts/SteamVR_RenderModel.cs - Dynamically creates associated SteamVR_Standalone provided models for tracked
objects.  See <SteamVR_Standalone Runtime Path>/resources/rendermodels for the full list of overrides.

Assets/SteamVR_Standalone/Scripts/SteamVR_Utils.cs - Various bits for working with the SteamVR_Standalone API in Unity including a
...
[SteamVR_Standalone] - This object controls some global settings for SteamVR_Standalone, most notably Tracking Space.  Legacy projects
...
Assets/SteamVR_Standalone/Scripts/SteamVR_Menu.cs demonstrates use of OnGUI with SteamVR_Camera's overlay texture.  The
...
SteamVR_Standalone fires off several events.  These can be handled by registering for them through
...
* HmdError_Init_VRClientDLLNotFound - Make sure the SteamVR_Standalone runtime is installed.  This can be found in Steam
under Tools.  Try uninstalling and reinstalling SteamVR_Standalone.  Try deleting <user>/AppData/Local/OpenVR/openvrpaths.vrpath
and relaunching Steam to regenerate this file.

* HmdError_Init_HmdNotFound - SteamVR_Standalone cannot detect your VR headset, ensure the USB cable is plugged in.
If that doesn't work, try deleting your Steam/config/steamvr.cfg.

* HmdError_Init_InterfaceNotFound - Make sure your SteamVR_Standalone runtime is up to date.

* HmdError_IPC_ConnectFailed - SteamVR_Standalone launches a separate process called vrserver.exe which directly talks
