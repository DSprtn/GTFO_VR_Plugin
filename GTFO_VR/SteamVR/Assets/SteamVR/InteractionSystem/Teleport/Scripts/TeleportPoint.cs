...
namespace Valve.VR.InteractionSystem
{
    ...
    public class TeleportPoint : TeleportMarkerBase
    {
        ...
        public void TeleportToScene()
        {
            ...
            {
                Debug.Log("<b>[SteamVR_Standalone Interaction]</b> TeleportPoint: Hook up your level loading logic to switch to new scene: " + switchToScene, this);
            }
            else
            {
                Debug.LogError("<b>[SteamVR_Standalone Interaction]</b> TeleportPoint: Invalid scene name to switch to: " + switchToScene, this);
            }
        }
