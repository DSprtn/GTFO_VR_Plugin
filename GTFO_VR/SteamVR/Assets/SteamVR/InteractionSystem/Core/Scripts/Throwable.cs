...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Throwable : MonoBehaviour
    {
        ...
        {
            //Debug.Log("<b>[SteamVR_Standalone Interaction]</b> Pickup: " + hand.GetGrabStarting().ToString());
        ...
        public virtual void GetReleaseVelocities(Hand hand, out Vector3 velocity, out Vector3 angularVelocity)
        {
            ...
            switch (releaseVelocityStyle)
            {
                case ReleaseStyle.ShortEstimation:
                    ...
                    {
                        Debug.LogWarning("[SteamVR_Standalone Interaction System] Throwable: No Velocity Estimator component on object but release style set to short estimation. Please add one or change the release style.");
