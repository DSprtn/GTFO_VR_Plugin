    ...
    public class Interactable : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            if (highlightMat == null)
                Debug.LogError("<b>[SteamVR_Standalone Interaction]</b> Hover Highlight Material is missing. Please create a material named 'SteamVR_HoverHighlight' and place it in a Resources folder", this);

            if (skeletonPoser != null)
            {
                if (useHandObjectAttachmentPoint)
                {
                    //Debug.LogWarning("<b>[SteamVR_Standalone Interaction]</b> SkeletonPose and useHandObjectAttachmentPoint both set at the same time. Ignoring useHandObjectAttachmentPoint.");
