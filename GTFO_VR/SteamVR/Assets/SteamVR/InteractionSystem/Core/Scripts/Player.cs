...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        [Tooltip("List of possible transforms for the head/HMD, including the no-SteamVR_Standalone fallback camera.")]
        public Transform[] hmdTransforms;

        [Tooltip("List of possible Hands, including no-SteamVR_Standalone fallback Hands.")]
        public Hand[] hands;

        [Tooltip("Reference to the physics collider that follows the player's HMD position.")]
        public Collider headCollider;

        [Tooltip("These objects are enabled when SteamVR_Standalone is available")]
        public GameObject rigSteamVR;

        [Tooltip("These objects are enabled when SteamVR_Standalone is not available, or when the user toggles out of VR")]
        ...
        protected virtual void Update()
        {
            ...
            if (headsetOnHead != null)
            {
                ...
                {
                    Debug.Log("<b>SteamVR_Standalone Interaction System</b> Headset placed on head");
                }
                else if (headsetOnHead.GetStateUp(SteamVR_Input_Sources.Head))
                {
                    Debug.Log("<b>SteamVR_Standalone Interaction System</b> Headset removed");
                }
            }
        }
