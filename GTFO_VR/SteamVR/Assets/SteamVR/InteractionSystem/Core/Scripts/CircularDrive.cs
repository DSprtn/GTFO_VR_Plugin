...
namespace Valve.VR.InteractionSystem
{
    ...
    public class CircularDrive : MonoBehaviour
    {
        ...
        private Vector3 ComputeToTransformProjected(Transform xForm)
        {
            ...
            {
                Debug.LogFormat("<b>[SteamVR_Standalone Interaction]</b> The collider needs to be a minimum distance away from the CircularDrive GameObject {0}", gameObject.ToString());
                Debug.Assert(false, string.Format("<b>[SteamVR_Standalone Interaction]</b> The collider needs to be a minimum distance away from the CircularDrive GameObject {0}", gameObject.ToString()));
            }
