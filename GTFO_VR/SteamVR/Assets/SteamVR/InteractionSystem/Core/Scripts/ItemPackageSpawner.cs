...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ItemPackageSpawner : MonoBehaviour
    {
        ...
        {
            Debug.LogError("<b>[SteamVR_Standalone Interaction]</b> ItemPackage assigned to " + gameObject.name + " is not valid. Destroying this game object.", this);
            Destroy(gameObject);
        }
        ...
        private void SpawnAndAttachObject(Hand hand, GrabTypes grabType)
        {
            ...
            if (itemPackage.otherHandItemPrefab != null)
            {
                ...
                {
                    Debug.Log("<b>[SteamVR_Standalone Interaction]</b> Not attaching objects because other hand is hoverlocked and we can't deliver both items.");
                    return;
                }
            }
