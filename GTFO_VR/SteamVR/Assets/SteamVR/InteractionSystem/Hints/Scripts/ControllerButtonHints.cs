...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ControllerButtonHints : MonoBehaviour
    {
        ...
        private void HintDebugLog(string msg)
        {
            if (debugHints)
            {
                Debug.Log("<b>[SteamVR_Standalone Interaction]</b> Hints: " + msg);
            }
        }
        ...
        void OnRenderModelLoaded(SteamVR_RenderModel renderModel, bool succeess)
        {
            ...
            {
                //Debug.Log("<b>[SteamVR_Standalone Interaction]</b> OnRenderModelLoaded: " + this.renderModel.renderModelName);
                if (initialized)
                {
        ...
        private void ComputeTextEndTransforms()
        {
            ...
            foreach (var hintInfo in actionHintInfos)
            {
                ...
                {
                    Debug.LogWarning("<b>[SteamVR_Standalone Interaction]</b> Invalid end position for: " + hintInfo.Value.textStartAnchor.name, hintInfo.Value.textStartAnchor.gameObject);
                }
